...
HD_PWD='C:/Users/xiz36/Desktop/hw2_sobel/hw2_sobel/sobel/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sobel.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sobel.tcl
